...
public class Test extends Application {
    ...
    public void start(Stage primaryStage) {
        VBox v = new VBox(10);
        v.setBackground(new Background(new BackgroundFill(Color.rgb(0, 100, 0), CornerRadii.EMPTY, Insets.EMPTY)));
        ...
        HBox h3 = new HBox(10);
        HBox h4 = new HBox(10);
        h1.setBackground(new Background(new BackgroundFill(Color.rgb(0, 100, 0), CornerRadii.EMPTY, Insets.EMPTY)));
        h2.setBackground(new Background(new BackgroundFill(Color.rgb(0, 100, 0), CornerRadii.EMPTY, Insets.EMPTY)));
        h3.setBackground(new Background(new BackgroundFill(Color.rgb(0, 100, 0), CornerRadii.EMPTY, Insets.EMPTY)));
        h4.setBackground(new Background(new BackgroundFill(Color.rgb(0, 100, 0), CornerRadii.EMPTY, Insets.EMPTY)));
